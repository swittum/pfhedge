...
class TestHestonJumpStock:
    ...
    def test_repr(self):
        s = HestonJumpStock()
        expect = "HestonJumpStock(\
kappa=1., theta=0.0400, sigma=0.2000, rho=-0.7000, jump_per_year=1., jump_mean=0., jump_std=0.3000, dt=0.0040)"
        assert repr(s) == expect

    def test_simulate_shape(self):
        s = HestonJumpStock(dt=0.1)
